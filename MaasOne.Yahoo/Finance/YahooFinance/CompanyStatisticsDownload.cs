        ...
        protected override CompanyStatisticsResult ConvertResult(Base.ConnectionInfo connInfo, System.IO.Stream stream, Base.SettingsBase settings)
        {
            ...
            if (stream != null)
            {
                ...
                if (resultNode != null)
                {
                    ...
                    {
                        if (divs[i].InnerXml().ToLower().Contains("valuation measures"))
                        {
                            vmNode = divs[i];
                            break;
                        }
                    ...
                    XElement fyNode = null;
                    // Fiscal Year
                    for (int i = divs.Length - 1; i > 0; i--)
                    {
                        if (divs[i].InnerXml().ToLower().Contains("fiscal year"))
                        {
                            fyNode = divs[i - 1];
                            break;
                        }
                    ...
                    XElement sphNode = null;

                    // Trading Information
                    for (int i = divs.Length - 1; i > 0; i--)
                    {
                        if (divs[i].InnerXml().ToLower().Contains("stock price history"))
                        {
                            sphNode = divs[i - 1];
                            break;
                        }
                    ...
                    if (sphNode != null)
                    {
                        ...
                        tempNode = XPath.GetElement("//div/div[3]/table/tbody/tr[10]/td[2]", sphNode, true);
